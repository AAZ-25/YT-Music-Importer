...
static void YTMIPresentMusicProgress(NSString *importID) {
    ...
    YTMIProgressAlert = [UIAlertController alertControllerWithTitle:@"YT Music Importer — 1.0 Beta 2" message:[NSString stringWithFormat:@"%@\nPreparing local import\nElapsed: 00:00", importID] preferredStyle:UIAlertControllerStyleAlert];
...
static void YTMIHandleMusicRequest(void) {
    @autoreleasepool {@synchronized(YTMIMusicDatabaseImporter.class) {
        ...
        NSDictionary *job=[NSDictionary dictionaryWithContentsOfFile:pending]; NSString *nonce=[job[@"nonce"]isKindOfClass:NSString.class]?job[@"nonce"]:nil; NSString *audio=[job[@"audioPath"]isKindOfClass:NSString.class]?job[@"audioPath"]:nil; NSString *importID=[job[YTMIJobImportIDKey]isKindOfClass:NSString.class]?job[YTMIJobImportIDKey]:@"B62-UNKNOWN";
        ...
        NSMutableArray *trace=[NSMutableArray arrayWithObjects:@"music.request.received",@"music.source.valid",nil]; NSDictionary *metadata=@{YTMIJobTitleKey:[job[@"title"]isKindOfClass:NSString.class]?job[@"title"]:@"",YTMIJobArtistKey:[job[@"artist"]isKindOfClass:NSString.class]?job[@"artist"]:@"",YTMIJobAlbumKey:[job[@"album"]isKindOfClass:NSString.class]?job[@"album"]:@"",YTMIJobImportIDKey:importID};
...
static void YTMIRelayFromSpringBoard(void) {
    @autoreleasepool {@synchronized(YTMIMusicDatabaseImporter.class) {
        NSString *directory=YTMIFindJobDirectory(); if(!directory.length)return; NSDictionary *job=[NSDictionary dictionaryWithContentsOfFile:[directory stringByAppendingPathComponent:@"pending.plist"]]; NSString *nonce=[job[@"nonce"]isKindOfClass:NSString.class]?job[@"nonce"]:nil; NSString *audio=[job[@"audioPath"]isKindOfClass:NSString.class]?job[@"audioPath"]:nil; NSString *importID=[job[YTMIJobImportIDKey]isKindOfClass:NSString.class]?job[YTMIJobImportIDKey]:@"B62-UNKNOWN"; NSMutableArray *trace=[NSMutableArray arrayWithObject:@"bridge.request.received"];
